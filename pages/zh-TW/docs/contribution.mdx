...
fastexcel 歡迎社群中的每一位使用者和開發者成為貢獻者。無論是回報問題、改進文件、提交程式碼，還是提供技術支援，您的參與將有助於 fastexcel 變得更好。
...
為了提高溝通效率，請在提交問題前：  
1. **搜尋現有問題**：檢查您的問題是否已被回報。如果存在，請直接在現有問題下評論補充詳細信息，而不是創建新問題。  
...
> **注意**：請勿在問題中包含敏感信息，如密碼、金鑰、伺服器位址或私人資料。
